...
const question1 = [
    {
        question: "A filling pipe can fill a pot in 40 minutes and wastage pipe can empty the filling pot in 60 minutes. Bymistake without closing the wastage pipe, the filling pipe opened. In how much time in empty pot can be filled it.",
        first: "52",
        second: "64",
        third: "110",
        fourth: "120",
...
const nxtBtn1 = document.getElementById("next_question");
